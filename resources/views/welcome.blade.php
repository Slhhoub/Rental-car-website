    ...
    <div class="row">
        ...
        <div class="col-lg-5 ">
            <div class=" text-center " style="margin-top:80px;">
                    <h1 >Welcome to <samp style="color:#15a0e1;">Car-SM</samp> </h1>
                    <p class="">It is the first service and is available to everyone without preconditions anywhere and anytime.It facilitates services for the citizen and provides more opportunities for mobility and facilitates things in proportion to mobility</p>
                </div>
            </div>
            ...
            <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
             <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src="photologin.png" class="d-block w-100" alt="..." height="400px">
                </div>
              </div>
